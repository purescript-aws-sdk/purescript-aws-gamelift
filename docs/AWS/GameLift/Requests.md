...
``` purescript
createGameSession :: forall eff. Service -> CreateGameSessionInput -> Aff (exception :: EXCEPTION | eff) CreateGameSessionOutput
```
...
``` purescript
deleteAlias :: forall eff. Service -> DeleteAliasInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteBuild :: forall eff. Service -> DeleteBuildInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteFleet :: forall eff. Service -> DeleteFleetInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteGameSessionQueue :: forall eff. Service -> DeleteGameSessionQueueInput -> Aff (exception :: EXCEPTION | eff) DeleteGameSessionQueueOutput
```
...
``` purescript
deleteMatchmakingConfiguration :: forall eff. Service -> DeleteMatchmakingConfigurationInput -> Aff (exception :: EXCEPTION | eff) DeleteMatchmakingConfigurationOutput
```
...
``` purescript
deleteScalingPolicy :: forall eff. Service -> DeleteScalingPolicyInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteVpcPeeringAuthorization :: forall eff. Service -> DeleteVpcPeeringAuthorizationInput -> Aff (exception :: EXCEPTION | eff) DeleteVpcPeeringAuthorizationOutput
```
...
``` purescript
deleteVpcPeeringConnection :: forall eff. Service -> DeleteVpcPeeringConnectionInput -> Aff (exception :: EXCEPTION | eff) DeleteVpcPeeringConnectionOutput
```
...
``` purescript
describeAlias :: forall eff. Service -> DescribeAliasInput -> Aff (exception :: EXCEPTION | eff) DescribeAliasOutput
```
...
``` purescript
describeBuild :: forall eff. Service -> DescribeBuildInput -> Aff (exception :: EXCEPTION | eff) DescribeBuildOutput
```
...
``` purescript
describeEC2InstanceLimits :: forall eff. Service -> DescribeEC2InstanceLimitsInput -> Aff (exception :: EXCEPTION | eff) DescribeEC2InstanceLimitsOutput
```
...
``` purescript
describeFleetAttributes :: forall eff. Service -> DescribeFleetAttributesInput -> Aff (exception :: EXCEPTION | eff) DescribeFleetAttributesOutput
```
...
``` purescript
describeFleetCapacity :: forall eff. Service -> DescribeFleetCapacityInput -> Aff (exception :: EXCEPTION | eff) DescribeFleetCapacityOutput
```
...
``` purescript
describeFleetEvents :: forall eff. Service -> DescribeFleetEventsInput -> Aff (exception :: EXCEPTION | eff) DescribeFleetEventsOutput
```
...
``` purescript
describeFleetPortSettings :: forall eff. Service -> DescribeFleetPortSettingsInput -> Aff (exception :: EXCEPTION | eff) DescribeFleetPortSettingsOutput
```
...
``` purescript
describeFleetUtilization :: forall eff. Service -> DescribeFleetUtilizationInput -> Aff (exception :: EXCEPTION | eff) DescribeFleetUtilizationOutput
```
...
``` purescript
describeGameSessionDetails :: forall eff. Service -> DescribeGameSessionDetailsInput -> Aff (exception :: EXCEPTION | eff) DescribeGameSessionDetailsOutput
```
...
``` purescript
describeGameSessionPlacement :: forall eff. Service -> DescribeGameSessionPlacementInput -> Aff (exception :: EXCEPTION | eff) DescribeGameSessionPlacementOutput
```
...
``` purescript
describeMatchmakingConfigurations :: forall eff. Service -> DescribeMatchmakingConfigurationsInput -> Aff (exception :: EXCEPTION | eff) DescribeMatchmakingConfigurationsOutput
```
...
``` purescript
describeMatchmakingRuleSets :: forall eff. Service -> DescribeMatchmakingRuleSetsInput -> Aff (exception :: EXCEPTION | eff) DescribeMatchmakingRuleSetsOutput
```
...
``` purescript
describePlayerSessions :: forall eff. Service -> DescribePlayerSessionsInput -> Aff (exception :: EXCEPTION | eff) DescribePlayerSessionsOutput
```
...
``` purescript
describeRuntimeConfiguration :: forall eff. Service -> DescribeRuntimeConfigurationInput -> Aff (exception :: EXCEPTION | eff) DescribeRuntimeConfigurationOutput
```
...
``` purescript
describeScalingPolicies :: forall eff. Service -> DescribeScalingPoliciesInput -> Aff (exception :: EXCEPTION | eff) DescribeScalingPoliciesOutput
```
...
``` purescript
describeVpcPeeringAuthorizations :: forall eff. Service -> DescribeVpcPeeringAuthorizationsInput -> Aff (exception :: EXCEPTION | eff) DescribeVpcPeeringAuthorizationsOutput
```
...
``` purescript
listAliases :: forall eff. Service -> ListAliasesInput -> Aff (exception :: EXCEPTION | eff) ListAliasesOutput
```
...
``` purescript
listFleets :: forall eff. Service -> ListFleetsInput -> Aff (exception :: EXCEPTION | eff) ListFleetsOutput
```
...
``` purescript
putScalingPolicy :: forall eff. Service -> PutScalingPolicyInput -> Aff (exception :: EXCEPTION | eff) PutScalingPolicyOutput
```
...
``` purescript
requestUploadCredentials :: forall eff. Service -> RequestUploadCredentialsInput -> Aff (exception :: EXCEPTION | eff) RequestUploadCredentialsOutput
```
...
``` purescript
resolveAlias :: forall eff. Service -> ResolveAliasInput -> Aff (exception :: EXCEPTION | eff) ResolveAliasOutput
```
...
``` purescript
searchGameSessions :: forall eff. Service -> SearchGameSessionsInput -> Aff (exception :: EXCEPTION | eff) SearchGameSessionsOutput
```
...
``` purescript
startMatchBackfill :: forall eff. Service -> StartMatchBackfillInput -> Aff (exception :: EXCEPTION | eff) StartMatchBackfillOutput
```
...
``` purescript
stopMatchmaking :: forall eff. Service -> StopMatchmakingInput -> Aff (exception :: EXCEPTION | eff) StopMatchmakingOutput
```
...
``` purescript
updateAlias :: forall eff. Service -> UpdateAliasInput -> Aff (exception :: EXCEPTION | eff) UpdateAliasOutput
```
...
``` purescript
updateBuild :: forall eff. Service -> UpdateBuildInput -> Aff (exception :: EXCEPTION | eff) UpdateBuildOutput
```
...
``` purescript
updateFleetAttributes :: forall eff. Service -> UpdateFleetAttributesInput -> Aff (exception :: EXCEPTION | eff) UpdateFleetAttributesOutput
```
...
``` purescript
updateFleetCapacity :: forall eff. Service -> UpdateFleetCapacityInput -> Aff (exception :: EXCEPTION | eff) UpdateFleetCapacityOutput
```
...
``` purescript
updateFleetPortSettings :: forall eff. Service -> UpdateFleetPortSettingsInput -> Aff (exception :: EXCEPTION | eff) UpdateFleetPortSettingsOutput
```
...
``` purescript
updateGameSession :: forall eff. Service -> UpdateGameSessionInput -> Aff (exception :: EXCEPTION | eff) UpdateGameSessionOutput
```
...
``` purescript
updateGameSessionQueue :: forall eff. Service -> UpdateGameSessionQueueInput -> Aff (exception :: EXCEPTION | eff) UpdateGameSessionQueueOutput
```
...
``` purescript
updateMatchmakingConfiguration :: forall eff. Service -> UpdateMatchmakingConfigurationInput -> Aff (exception :: EXCEPTION | eff) UpdateMatchmakingConfigurationOutput
```
...
``` purescript
updateRuntimeConfiguration :: forall eff. Service -> UpdateRuntimeConfigurationInput -> Aff (exception :: EXCEPTION | eff) UpdateRuntimeConfigurationOutput
```
...
``` purescript
validateMatchmakingRuleSet :: forall eff. Service -> ValidateMatchmakingRuleSetInput -> Aff (exception :: EXCEPTION | eff) ValidateMatchmakingRuleSetOutput
```
